...
from mech_interp.feature_analysis_utils import (
...
ALL_BIAS_TYPES = ["Race_2", "Gender", "Stereoset", "Pos_vs_Neg", "BBQ_Race"]
...
scoring_method = (
    "absolute_difference"  # 'absolute_difference', 'relative_difference', 't_test'
)
testing_layers = LAYERS_WITH_SAE
...
top_scores_layers, minmax_layerwise_scores = get_layerwise_latent_scores(
    model_alias, LAYERS_WITH_SAE, tokens_to_cache, scoring_method, ALL_BIAS_TYPES, top_k
)
