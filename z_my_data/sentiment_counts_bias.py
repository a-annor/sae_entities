...
def append_sentiment_count(input_file):
    input_path = f"z_my_data/test_prompt_data_completions_bias/{input_file}.jsonl"
    output_path = f"z_my_data/test_prompt_data_sentiment_bias/{input_file}_sentiment.jsonl"
