...
if __name__ == "__main__":
    ...
    parser.add_argument('--input-json-path', type=str, default='/home/ana42/rds/hpc-work/sae_entities/data/test_prompt_data_judged/test_Race_ethnicity_completion_sentiment_judged.jsonl')
    parser.add_argument('--output-json-path', type=str, default='/home/ana42/rds/hpc-work/sae_entities/data/test_prompt_optim/test_Race_ethnicity_completion_optim.jsonl')
